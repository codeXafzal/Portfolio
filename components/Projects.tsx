...
const projects = [
  {
    id: '001',
    title: 'MAINTENANCE LOG APP',
    subtitle: 'Web3 Blockchain + Ethereum',
    image: 'https://images.unsplash.com/photo-1639322537228-f710d846310a?w=800',
    github: 'https://github.com/codeXafzal/Maintaince-Log_app',
  },
  {
    id: '002',
    ...
    github: 'https://github.com/codeXafzal/car-selling-price-prediction',
  },
  {
    id: '003',
    title: 'CHEMICAL EQUIPMENT VISUALIZER',
    subtitle: 'Django + React Analytics Dashboard',
  image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800',


    github: 'https://github.com/codeXafzal/Chemical-Equipment-Visualizer',
  },
  {
    id: '004',
    ...
    github: 'https://github.com/codeXafzal/boston-house-prediction',
  },
];
  ...
  return (
    <section id="models" ref={containerRef} className="py-20 bg-black">
      <div className="container mx-auto px-4">
        ...
        {/* Featured Project Cards (UNCHANGED) */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-20">
          <FeaturedCard
            title="OLLAMA CODE EXPLAINER"
            subtitle="It is a code explainer model built using Ollama and fine-tuned on a custom dataset of code snippets and explanations."
          ...
          <FeaturedCard
            ...
            subtitle="Research paper exploring AI-driven content moderation using ML algorithms."
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 right-0 p-8">
        <div className="text-sm text-gray-300 mb-2 tracking-wider">
          {subtitle}
        </div>
        <h3 className="text-3xl md:text-4xl font-bebas text-white mb-4 tracking-wide">
          {title}
        </h3>
